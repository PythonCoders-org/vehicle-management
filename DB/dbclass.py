...
class Tyre_reg(db.Model):
    ...
    year = db.Column(db.Integer)
    voucher_number = db.Column(db.String(100))
    type_number = db.Column(db.String(100))
    ...
    def __init__(self, date=None, month=None, year=None, voucher_number=None,type_number = None,vehicle_id = None,
                date_of_issue = None,on_date= None,on_date_meter_reading = None, off_date=None, 
